...
\newcommand{\pref}{\boldsymbol{\succeq}^\textbf{r}}%real, complete pref
\newcommand{\ppref}{\succeq^\text{p}}%partial pref
\newcommand{\prof}{(\boldsymbol{\succeq}^\textbf{r}_i)_{i \in N}}
\newcommand{\profshort}{\boldsymbol{R}^\textbf{r}}
\newcommand{\pprof}{(\succeq_i^\text{p})_{i \in N}}
...
\newcommand{\allsvs}{[0, m-1]^N}%all score-vectors
...
\newcommand{\prefsv}{\text{\textpdfrender{TextRenderingMode=FillStroke,LineWidth=.15pt}{$\succcurlyeq$}\textsuperscript{\textbf{r}}}}%pref over score-vectors
\newcommand{\sprefsv}{{\boldsymbol{\succ}^\textbf{r}}}%strict pref over score-vectors
\newcommand{\iprefsv}{\boldsymbol{\approx}^\textbf{r}}%indiff, pref over score-vectors
