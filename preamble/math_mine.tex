...
\newcommand{\pref}{\boldsymbol{\succeq}^\textbf{c}}%complete pref
\newcommand{\ppref}{\succeq^\text{p}}%partial pref
\newcommand{\prof}{(\boldsymbol{\succeq}^\textbf{c}_i)_{i \in N}}
\newcommand{\profshort}{\boldsymbol{R}^\textbf{c}}
...
\newcommand{\prefsvs}{\triangleright}%strict pref over score-vectors
\newcommand{\prefsv}{\boldsymbol{\succcurlyeq}^\textbf{c}}%complete pref over score-vectors
\newcommand{\pprefsv}{\succcurlyeq^\text{p}}%partial pref over score-vectors
