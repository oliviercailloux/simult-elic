...
%When talking about some generic voting rule we use the letter $F$, when we do not specify $F$ it is implied we talk about the $F=G$ that describes the committee preference for justice. 
