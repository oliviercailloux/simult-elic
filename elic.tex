...
Observe that $\#_B = \#_{B, ¬\emptyset} = [(m-b)!]^{n-1}$. \commentOC{Previously we had (counting all profiles): $\binom{m^n - b}{m-b}$. I don’t remember how we got this but I doubt that’s correct.} 
